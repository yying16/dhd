...
(function (global, factory) {
            ...
            if (isTrue(hydrating)) {
              if (hydrate(oldVnode, vnode, insertedVnodeQueue)) {
                ...
                warn(
                  ...
                  'HTML markup, for document nesting block-level elements inside ' +
    ...
    if (staticClass) {
      ...
      if (res) {
        warn(
          ...
          'Use v-bind or the colon shorthand instead. For document, ' +
  ...
  function genScopedSlots (
    ...
    // for document if the slot contains dynamic names, has v-if or v-for on them...
